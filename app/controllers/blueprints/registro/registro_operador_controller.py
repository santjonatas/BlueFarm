...
registro_operador_controller = Blueprint('registro-operador', __name__, template_folder='views/templates')


@registro_operador_controller.route('/registro-operador', methods=['GET','POST'])
def login():
