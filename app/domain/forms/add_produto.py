...
#         validators=[DataRequired(),
#             Length(min=1.00, message="O preço deve ter pelo menos 1 real.")
#     ])
...
#         validators=[DataRequired(),
#             Length(min=2, message="A descrição do insumo deve ter pelo menos 2 caracteres.")
#     ])
#     preco_insumo = DecimalField('Preço do Insumo',
#         validators=[DataRequired(),
#             Length(min=1.00, message="O preço do insumo deve ter pelo menos 1 real.")
#     ])
#     quantidade_disponivel_insumo = IntegerField('Quantidade disponível de insumos',
#         validators=[DataRequired()
#     ])
#     comprado_em = DateField('Preço do insumo',
#         validators=[DataRequired(),
#             Length(min=1.00, message="O preço deve ter pelo menos 1 real.")
#     ])
...
#             'imagem': self.file.data.filename if self.file.data else None  # Nome da imagem enviada
#         }
